...
更新：2026-09-04。正文接口跟着「这个身份有没有走过 GT3 bind」走。本机 Node 黑盒 `stamp_gt3()`（不依赖 RuyiDOM）已把新游客独立会话打成 `100000`。纯算 `w` 仍是 `error_03`，不能标 algorithmic。本文件只记录已经闭合的事实。
